...
$sql ="SELECT * FROM `tbl_subjects` where `standard`='".$standard."'";
...
if (($result->rowCount()) > 0) {
    ...
    {   
      	echo "<tr><td>".$row["standard"]."</td><td>".$row["subject_name"]."</td><td><a href=updateSubject.php?id=".$row["sub_id"].">Update</a> | <a onclick='delete_sub(".$row['sub_id'].")'>Delete</a></td><tr>";
    }
  ...
  <script type="text/javascript">
	...
	function delete_sub(i)
		{
			if (confirm("Are you sure you want to delete"))
			{
			var dataString = 'subject_id='+ i;
			$.ajax({
					type: "POST",
					url:"ajax.php?action=subject_delete",
					data: dataString,
					cache: false,
